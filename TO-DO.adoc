...
- Homogenize "forne" (6 in Cosmoglotta) - "forn" (11 in Cosmoglotta).
- Homogenize commas before "etc".  
- Fix notation "(intr.)" and "(tr.)" and split them.
...
- Confirmar "MISS TARGET" = "mancar cible" vice "fallir cible".
